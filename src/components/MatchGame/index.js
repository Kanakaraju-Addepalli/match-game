...
class MatchGame extends Component {
  ...
  onClickThumbnail = thumbnailUrl => {
    ...
    const {imageUrl} = filteredImage[0]
    if (imageUrl === imgUrl) {
      const newImageUrl =
  ...
  render() {
    const {isTrue, score, time, imgUrl, activeTabId} = this.state
    ...
    return (
      <div className="app-container">
        ...
        <div className="match-image-and-tabs-container">
          {isTrue ? (
            this.renderScoreCard()
          ) : (
            <div className="image-and-tabs-container">
              <div className="matched-image-container">
                <img src={imgUrl} className="matched-image" alt="match" />
              </div>
                  ...
                  {thumbnailList.map(eachObject => (
                    <li key={eachObject.id}>
                      <button
                        ...
                        onClick={() =>
                          this.onClickThumbnail(eachObject.thumbnailUrl)
                        }
                      >
                        <img
